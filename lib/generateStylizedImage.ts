    ...
    parts: [
      {
        text: [
          ...
          "The artwork should fill the frame from the top, left, and right edges with no white padding on those three sides; we will add a uniform white border around all four sides in post-processing.",
          "Leave a 15-25% white margin at the bottom of the frame so the subjects do not touch the bottom edge; the artwork should artistically transition to white at the bottom within that margin.",
